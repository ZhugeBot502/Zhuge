...
export const config = {
  ...
  credits: "kshitiz",
  cooldown: 20,
  description: "bot will send you random video to entertain you",
  usage: "",
};
...
export async function onCall({ message }) {
  ...
  const loadingMessage = await message.reply("🤡| Let me entertain, you wait...");
  ...
  const availableVideos = driveLinks.filter(video => !sentVideos.includes(video));
  ...
  sentVideos.push(randomDriveLink);
