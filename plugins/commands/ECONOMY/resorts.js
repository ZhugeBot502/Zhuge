...
function calculateResortValue(level) {
  ...
  const valueIncrease = level * 2000 * level; // Increased value every 2 minutes based on level (incremental increase)
...
async function onCall({ message, getLang, args }) {
  ...
  if (args[0] === "collect") {
    ...
    const collectMessage = `𝚈𝚘𝚞'𝚟𝚎 𝚌𝚘𝚕𝚕𝚎𝚌𝚝𝚎𝚍 ₱${collectedAmount} 𝚒𝚗𝚌𝚘𝚖𝚎 𝚏𝚛𝚘𝚖 𝚢𝚘𝚞𝚛 𝚛𝚎𝚜𝚘𝚛𝚝! 💰`; // Using collectedAmount as a number
