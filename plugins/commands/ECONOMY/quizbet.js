...
const config = {
  name: "quizbet",
  aliases: ["qb"],
  description: "Answer a trivia question to win XC",
  usage: "",
  credits: "TakiUwU && Isai (MODIFIED by Dymyrius)"
};
...
async function onCall({ message, args, getLang }) {
  ...
  const apiUrl = `https://opentdb.com/api.php?amount=1&difficulty=${randomDifficulty}`;
  try {
