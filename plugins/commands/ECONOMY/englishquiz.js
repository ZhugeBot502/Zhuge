...
const config = {
  name: "englishquiz",
  aliases: ["equiz", "eq", "englishtrivia"],
  description: "Test your knowledge with a english quiz. Place a bet to win or lose money.",
  usage: "<bet amount>",
  cooldown: 10,
  credits: "Dymyrius"
};

const quizDataPath = join(global.assetsPath, 'englishquiz.json');
